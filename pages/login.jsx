          ...
          <div className="px-8 py-10 w-100" style={{ background: 'white' }}>
            ...
            <form onSubmit={handleLogin}>
              <div>
                ...
                <div className="mb-4"><div className="form-group"><div className="flex justify-between"><label htmlFor="email" className="font-weight-bold block mb-1" style={{ fontSize: 16 }}>Email</label></div>
              ...
              <div><div className="form-group"><div className="flex justify-between"><label htmlFor="password" className="font-weight-bold block mb-1" style={{ fontSize: 16 }}>Password</label><a href="#forgot-password" className="text-light-blue font-weight-bold" id="forgetPassword">Forgot password</a></div><div className="position-relative">
